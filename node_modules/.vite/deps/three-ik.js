...
var IKBallConstraint = function() {
  function IKBallConstraint2(angle) {
    classCallCheck(this, IKBallConstraint2);
    this.angle = angle;
  }
  createClass(IKBallConstraint2, [{
    key: "_apply",
  ...
  return IKBallConstraint2;
}();
var Y_AXIS = new Vector3(0, 1, 0);
var IKJoint = function() {
  function IKJoint2(bone) {
    var _ref = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, constraints = _ref.constraints;
    classCallCheck(this, IKJoint2);
...
var IKChain = function() {
  ...
  createClass(IKChain2, [{
    key: "add",
    value: function add(joint) {
      var _ref = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, target = _ref.target;
      if (this.effector) {
...
var BoneHelper = function(_Object3D) {
  inherits(BoneHelper2, _Object3D);
  function BoneHelper2(height, boneSize, axesSize) {
    classCallCheck(this, BoneHelper2);
    var _this = possibleConstructorReturn(this, (BoneHelper2.__proto__ || Object.getPrototypeOf(BoneHelper2)).call(this));
    if (height !== 0) {
...
var IKHelper = function(_Object3D2) {
  inherits(IKHelper2, _Object3D2);
  function IKHelper2(ik) {
    var _ref = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, color = _ref.color, showBones = _ref.showBones, boneSize = _ref.boneSize, showAxes = _ref.showAxes, axesSize = _ref.axesSize, wireframe = _ref.wireframe;
    classCallCheck(this, IKHelper2);
    var _this2 = possibleConstructorReturn(this, (IKHelper2.__proto__ || Object.getPrototypeOf(IKHelper2)).call(this));
    ...
    _this2.ik = ik;
    _this2._meshes = /* @__PURE__ */ new Map();
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = void 0;
    try {
    ...
    _this2.showBones = showBones !== void 0 ? showBones : true;
    _this2.showAxes = showAxes !== void 0 ? showAxes : true;
    _this2.wireframe = wireframe !== void 0 ? wireframe : true;
    _this2.color = color || new Color(16711799);
    return _this2;
  }
  createClass(IKHelper2, [{
    ...
    value: function updateMatrixWorld(force) {
      ...
      get(IKHelper2.prototype.__proto__ || Object.getPrototypeOf(IKHelper2.prototype), "updateMatrixWorld", this).call(this, force);
    }
  }, {
    key: "showBones",
    get: function get$$1() {
...
//# sourceMappingURL=three-ik.js.map
